...
from web_plugin.api_package.schemas import RUN_TELEMETRY_COLLECTION_SCHEMA_GET, STOP_TELEMETRY_COLLECTION_SCHEMA_GET, PERIOD_REQUEST_DATA, COMMON_RETURN_SCHEMA
